function [T] = intensity_based_registration_mono(path, fixed_image_path, moving_image_path, fixed_landmark_path, moving_landmark_path)

fprintf('intensity_based_registration_mono : working...\n');
